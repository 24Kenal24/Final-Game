...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static final Font COMIC_SANS = new Font("Comic Sans MS", Font.PLAIN, 16);

    public static final Font BIG_COMIC_SANS = new Font ("Comic Sans MS", Font.PLAIN, 40);

    public static final Font BIGGER_COMIC_SANS = new Font ("Comic Sans MS", Font.BOLD, 64);
